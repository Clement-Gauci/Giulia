...
final class DoctrineAccountRepositoryTest extends DatabaseTestCase
{
    ...
    public function test_it_stores_and_restores_every_field(): void
    {
        ...
        $repository->save(new Account(self::EMAIL, 'Clément', true, $created, $created->modify('+1 hour')));
        $this->em->clear();
    ...
    public function test_saving_twice_updates_the_same_account(): void
    {
        ...
        $account = Account::create(self::EMAIL, 'Clément', $now);
    ...
    {
        $this->repository()->save(Account::create(self::EMAIL, 'Clément', new \DateTimeImmutable()));
        $this->em->clear();
